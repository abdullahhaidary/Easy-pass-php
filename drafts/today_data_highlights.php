...
<div class="data" style="margin-left:20px ;justify-content: center">
    ...
    <table  style="border:2px solid black; border-collapse: collapse; text-align: center">
        <tr>
            ...
            <td style="border:2px solid black; border-collapse: collapse; font-size:16pt"><b>status2</b></td>
            <td style="border:2px solid black; border-collapse: collapse; font-size:16pt"><b>username2</b></td>
        ...
        <tr>
            ...
            <td style='border:2px solid black; border-collapse: collapse'>".$row['status2']."</td>
            <td style='border:2px solid black; border-collapse: collapse'>".$row['username2']."</td>
