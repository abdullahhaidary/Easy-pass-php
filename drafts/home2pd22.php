...
font-size: 16pt;background-color:white; width:100%;height:100px; text-align: center; border-color:white'><tr>
                                        ...
                                        ";
                    if($row['status2']=="NTN"){
                        echo"<button style='font-size:16pt;' onclick=\"document.getElementById('household').disabled='false'\"><a href='home2pd22.php?addid=".$row['hh']." & addidpbl=".$row['pbl']."& household=".$row['hh']."'  style='text-decoration: none'>Received</a></button>";
                        echo "<script>document.getElementById('household').disabled=true</script>";
                    }
                    if($row['status2']=="NTN"){
                        echo"<button style='font-size:16pt;' onclick=\"document.getElementById('household').disabled='false'\"><a href='home2pd22.php?notthisone=on' style='text-decoration: none'>Not This One</a></button>";
                    }
                    else{
                        echo "<button style='background-color: red;'><a style='color:white;' href='home2pd22.php?deleteidpbl=".$row['pbl']."& household=".$row['hh']."' style='text-decoration: none'>Delete</a></button>";
